...
urlpatterns=[
    ...
    path('secondary/', views.GetThisSpecialistPrimaryInfo.as_view(), name='specialist-secondary'),
    path('secondary/<str:pk>/', views.GetSpecialistIdPrimaryInfo.as_view(), name='specialist-secondary-id'),
    path('update-secondary/', views.UpdateSpecialistInfo.as_view(), name='specialist-update-secondary'),
