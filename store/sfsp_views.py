...
#     @swagger_auto_schema(request_body=plantAdvanceSerializer)
#     def post(self, request, format=None):
...
#     @swagger_auto_schema(request_body=toolAdvanceSerializer)
#     def post(self, request, format=None):
...
# #                 data['pageCount'] = ceil(plants.count()/count)
...
#     @swagger_auto_schema(request_body=paginatorSerializer)
#     def post(self, request, format=None):
#         """allPagination"""
#         getData = paginatorSerializer(data=request.data)
#         if getData.is_valid():
...
#     @swagger_auto_schema(request_body=allAdvanceSerializer)
#     def post(self, request, format=None):
#         """advance search in all products"""
#         getData = allAdvanceSerializer(data=request.data)
#         if getData.is_valid():
