...
urlpatterns = [
    ...
    path('admin/plant-comment-approve/<uuid:pk>/', comment_views.PlantCommentAdminApprove.as_view(), name="plant_admin_comment_approve"), # noqa
    path('admin/tool-comment-approve/<uuid:pk>/', comment_views.ToolCommentAdminApprove.as_view(), name="tool_admin_comment_approve"), # noqa
